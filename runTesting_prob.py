...
parser.add_argument("--prefixPredictedFN", default="/shenlab/lab_stor5/dongnie/challengeData/res_traindata/preCha_wce_wdice_viewExp_resEhance_fullAD_0110_iter14w_", type=str, help="prefix of the to-be-saved predicted filename")
