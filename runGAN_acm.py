...
parser.add_argument("--gpuID",default='4',type=str, help="the GPU ID")
...
parser.add_argument("--iter_size", type=int, default=8, help="number of iterations(actually, it is batches) to update the network parameters")
